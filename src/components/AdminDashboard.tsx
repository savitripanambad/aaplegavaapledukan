...
import { Shop, Worker, ClaimRequest, District, Category } from '../types';
import {
  ADMIN_NAME,
  ADMIN_NAME_MR,
  ADMIN_UPI_ID,
...
export const AdminDashboard: React.FC<AdminDashboardProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'pendingShops' | 'allShops' | 'payments' | 'workers' | 'claims'>('pendingShops');
